// components/generate/SkeletonCard.jsx
// PURPOSE: Loading placeholder shown while AI generates project ideas.
//          Uses animated shimmer blocks that mirror the real ProjectCard layout.
...
function SkeletonCard({ index }) {
  return (
    <div className="glass-card p-8 sm:p-10" style={{ animationDelay: `${index * 100}ms` }}>
